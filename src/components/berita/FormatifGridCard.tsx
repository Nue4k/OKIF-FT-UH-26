    ...
    <div className="w-full max-w-[360px] sm:max-w-none mx-auto flex flex-col bg-white rounded-[18px] sm:rounded-[24px] shadow-lg overflow-hidden group hover:-translate-y-2 transition-all duration-300">
      ...
      <div className="h-[160px] min-[360px]:h-[175px] sm:h-[210px] md:h-[150px] lg:h-[230px] w-full relative overflow-hidden rounded-t-[18px] sm:rounded-t-[24px]">
        ...
        <img
          src={image || '/r54.png'}
          alt={title}
          className="w-full h-full object-cover object-center rounded-t-[18px] sm:rounded-t-[24px] group-hover:scale-105 transition-transform duration-500"
        />
      </div>

      {/* Card Body */}
      <div className="px-3.5 py-3 sm:px-5 sm:py-4 md:px-3.5 md:py-3.5 lg:px-5 lg:py-4 flex flex-col justify-between flex-1 gap-2 sm:gap-3 md:gap-2.5 lg:gap-3 bg-white rounded-b-[18px] sm:rounded-b-[24px]">
        <div className="flex flex-col gap-1 sm:gap-2 md:gap-1.5 lg:gap-2">
          ...
          {/* Title */}
          <h3 className="text-[#080A8F] text-[15px] sm:text-base md:text-base lg:text-[22px] font-bold leading-snug line-clamp-2">
            {title}
          </h3>

          {/* Description */}
          <p className="text-[#080A8F]/90 text-xs sm:text-sm md:text-xs lg:text-[15px] font-normal leading-relaxed line-clamp-3">
            {description}
          </p>
        </div>
