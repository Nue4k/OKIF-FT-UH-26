...
export default function FormatifGridCard({
  ...
  return (
    <div className="w-full max-w-90 sm:max-w-none mx-auto flex flex-col bg-white rounded-[18px] sm:rounded-3xl shadow-lg overflow-hidden group hover:-translate-y-2 transition-all duration-300">
      {/* Top Image */}
